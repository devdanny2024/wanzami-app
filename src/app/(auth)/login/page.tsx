      ...
      <form className="space-y-6">
        <div>
          ...
          <input
            ...
            autoComplete="email"
            required
            className="mt-1 block w-full px-3 py-2 bg-[#0B0C10] border border-gray-700 rounded-md text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500"
